...
int main(int argc, char* argv[])
{
    ...
    if (!lambdaWorker)
        std::cout << "" << std::endl;
    ...
    auto testWorker2 = std::make_shared<TestWorker>(&core, nullptr);

    core.registerWorker(testWorker2);

    std::cout << "answer is " << testWorker2->answer << std::endl;
